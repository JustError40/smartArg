...
**Ссылка на рабочий проект:** https://your-username.pythonanywhere.com
...
## Скриншоты
Добавьте сюда 2–3 скриншота интерфейса (например, `templates/dashboard.png`, `templates/knowledge_base.png`).

![](templates/dashboard.png)
*Главная панель — обзор чатов и недавно найденных важных сообщений.*

![](templates/knowledge_base.png)
*Структурированная база знаний: задачи, дедлайны и пояснения преподавателя.*
